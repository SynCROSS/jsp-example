 ...
 * Generated at: 2020-11-26 04:37:11 UTC
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t");
		...
		ResultSet rs = stmt.executeQuery(" SELECT " + " id, " + " CASE gender " + " WHEN 'F'   THEN " + " '여성' "
		+ " WHEN 'M'   THEN " + " '남성' " + " ELSE " + " '' " + " END 성별, " + " CASE favorit " + " WHEN 'KO'   THEN "
		+ " '국어' " + " WHEN 'MA'   THEN " + " '수학' " + " WHEN 'CO'   THEN " + " '컴퓨터' " + " ELSE " + " '' "
		+ "END \"좋아하는 과목\"" + " FROM " + " student ");
